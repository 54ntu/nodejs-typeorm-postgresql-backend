...
const models: TsoaRoute.Models = {
    ...
    "Media": {
        ...
        "properties": {
            ...
            "deleteAt": {"dataType":"datetime","required":true},
    ...
    "FoodSpicyness": {
        "dataType": "refEnum",
        "enums": ["MILD","MEDIUM","SPICY","EXTRA_SPICY"],
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Category": {
        "dataType": "refObject",
    ...
    "Food": {
        ...
        "properties": {
            ...
            "spicyness": {"ref":"FoodSpicyness","required":true},
...
export function RegisterRoutes(app: Router,opts?:{multer?:ReturnType<typeof multer>}) {
    ...
    const upload = opts?.multer ||  multer({"limits":{"fileSize":8388608}});
        ...
        const argsCategoryController_createCategory: Record<string, TsoaRoute.ParameterSchema> = {
                categoryName: {"in":"formData","name":"categoryName","required":true,"dataType":"string"},
